...
4. **Accounts**: Accounts are broken down into two sections. **Bank Accounts / Cash** hold your money and assets while **Credit Cards**, as expected, are debts.

5. **Net Worth Categories**: These categories encompass all of your assets and debts (both budgeted and non-budgeted). Categories can be as broad or as narrow as you prefer depending on your particular situation.

6. **Hidden Categories** and **Hidden Accounts**: These are old Categories or Accounts that you no longer use. They can be added to their repsective sections to "retire" them and remove them from your primary budget.

<Image href={require('../images/aspire_tabs/Configuration.png')}/>
